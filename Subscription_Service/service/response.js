...
function Response(resp) {
    ...
    return {
        ...
        error: function (err, contentBuilder, headerBuilder) {
            ...
            var content = err.currentState ? currentStateContent() : err.message;
            var headers = headerBuilder ? headerBuilder(err.currentState) : null;

            if (err instanceof RangeError || err instanceof BadRequestException) {
            ...
            } else if (err instanceof ConcurrencyException) {
