...
using StreamingPlatform.Dtos.Mappers;
...
namespace StreamingPlatform.Services
{
    public class PlanService(IUnitOfWork unitOfWork, IMapper mapper) : IPlanService
    {
        ...
        /// </returns>
        public async Task<PagedResponseOffsetDto<PlanResponse>> GetPlans(int pageSize, int currentPage)
        {
            ...
            return this.mapper.Map<PagedResponseOffsetDto<PlanResponse>>(plans);
        }
